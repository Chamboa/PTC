...
class PantallaCarga : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.pantalla_de_carga) // Usa el layout pantalla_de_carga
        ...
        Handler(Looper.getMainLooper()).postDelayed({
            ...
            val intent = if (hasComite) {
                Intent(this, ComiteActivity::class.java)
            } else {
                Intent(this, pantallaprincipalalumnos::class.java)
            }
